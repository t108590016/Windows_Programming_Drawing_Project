...
namespace GoogleDriveUploader.GoogleDrive
{
    public class GoogleDriveService
    {
        ...
        //query
        private void Query(FilesResource.ListRequest listRequest, List<Google.Apis.Drive.v2.Data.File> returnList)
        {
            try
            {
        ...
        //upload
        private void Upload(FilesResource.InsertMediaUpload insertRequest, FileStream uploadStream, Action<IUploadProgress> uploadProgressEventHandler, Action<Google.Apis.Drive.v2.Data.File> responseReceivedEventHandler)
        {
        ...
        public Google.Apis.Drive.v2.Data.File UploadFile(string uploadFileName, string contentType, Action<IUploadProgress> uploadProgressEventHandler = null, Action<Google.Apis.Drive.v2.Data.File> responseReceivedEventHandler = null)
        {
            ...
            Upload(insertRequest, uploadStream, uploadProgressEventHandler, responseReceivedEventHandler);
